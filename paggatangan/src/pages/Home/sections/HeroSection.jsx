...
function HeroSection() {
  return (
    <section className="bg-gradient h-screen flex items-center px-12 relative overflow-hidden">
      ...
      <div className='absolute left-[5%] top-[35%] z-40 p-10'>
        ...
        <button className='bg-gold-400 hover:bg-gold-500 px-10 py-3 mt-4 rounded'>Shop Now</button>
      </div>
      ...
      <div className="absolute right-[16%] top-0 w-[15%] h-screen bg-beige-200 skew-x-[-25deg] z-10"></div>
      <div className="absolute right-[31%] top-0 w-[15%] h-screen bg-beige-600 skew-x-[-25deg] z-10"></div>
